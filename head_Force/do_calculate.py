...
def get_problem_kwargs(**main_kwargs):
    calculate_fun_dict = {'do_calculate_helix_Petsc4n':            spf_tb.do_calculate_helix_Petsc4n,
                          'do_calculate_helix_AvrPetsc4n':         spf_tb.do_calculate_helix_AvrPetsc4n,
                          'do_calculate_ellipse_Petsc4n':          spf_tb.do_calculate_ellipse_Petsc4n,
                          'do_calculate_ellipse_AvrPetsc4n':       spf_tb.do_calculate_ellipse_AvrPetsc4n,
                          'do_calculate_ecoli_Petsc4n':            spf_tb.do_calculate_ecoli_Petsc4n,
                          'do_calculate_ecoli_AvrPetsc4n':         spf_tb.do_calculate_ecoli_AvrPetsc4n,
                          'do_calculate_ecoli_passive_Petsc4n':    spf_tb.do_calculate_ecoli_passive_Petsc4n,
                          'do_calculate_ecoli_passive_AvrPetsc4n': spf_tb.do_calculate_ecoli_passive_AvrPetsc4n, }
    OptDB = PETSc.Options()
...
def do_pickel(Table_t, Table_dt, Table_X, Table_P, Table_P2, Table_theta, Table_phi, Table_psi,
    ...
    save_list = ('ini_theta', 'ini_phi', 'ini_psi', 'ini_t', 'max_t', 'eval_dt', 'update_fun',
                 'rtol', 'atol', 'table_name', 'omega_tail', 't_name', 'save_every',
                 'simulate_t', 'Table_t', 'Table_dt', 'Table_X', 'Table_P', 'Table_P2',
...
def main_fun(**main_kwargs):
    ...
    Table_t, Table_dt, Table_X, Table_P, Table_P2, Table_theta, Table_phi, Table_psi, Table_eta = \
        calculate_fun(tnorm, ini_psi, max_t, update_fun=update_fun, rtol=rtol, atol=atol,
                      eval_dt=eval_dt, table_name=table_name, save_every=save_every, tqdm_fun=tqdm,
                      omega_tail=omega_tail)
    t1 = time()
    simulate_t = t1 - t0
